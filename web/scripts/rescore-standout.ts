...
import { scoreInstitutionMonth, computeStandoutDims, type OcrMenuItem } from '../lib/institutionScore.ts';
...
async function main() {
  ...
  for (const m of menus) {
    ...
    const patch = {
      ...
      day_count: sc.dayCount, item_count: sc.itemCount, standout_dims: dims,
