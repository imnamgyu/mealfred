...
export const MENU_MAP: Record<string, { ing: string[]; processed?: boolean }> = {
  ...
  '주먹밥': { ing: ['쌀','계란','당근'] },
  '김': { ing: ['김'] }, '김자반': { ing: ['김'] }, '조미김': { ing: ['김'] }, '구이김': { ing: ['김'] }, '맛김': { ing: ['김'] }, '구운김': { ing: ['김'] }, '김구이': { ing: ['김'] },
  ...
  '무생채': { ing: ['무'] }, '오이무침': { ing: ['오이'] }, '깍두기': { ing: ['무'] }, '미니깍두기': { ing: ['무'] }, '석박지': { ing: ['무'] }, '섞박지': { ing: ['무'] },
  ...
  '미트볼': { ing: ['소고기'], processed: true }, '미트볼구이': { ing: ['소고기'], processed: true }, '미트볼채소조림': { ing: ['소고기'], processed: true },
