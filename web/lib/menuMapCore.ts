...
const EXCLUDE = new Set([
  ...
  '멸치젓', '새우젓', '액젓', '까나리액젓', '멸치액젓', '토마토케찹', '케찹', '케첩', '케챂', '단무지', '짜장', '간짜장', '춘장',
]);
...
export const MENU_MAP: Record<string, { ing: string[]; processed?: boolean }> = {
  ...
  '시금치나물': { ing: ['시금치','마늘'] },
  '깻잎무침': { ing: ['들깻잎'] }, '깻잎순나물': { ing: ['들깻잎'] }, '깻잎나물': { ing: ['들깻잎'] },
  ...
  '주먹밥': { ing: ['쌀','계란','당근'] },
  '김': { ing: ['김'] }, '김자반': { ing: ['김'] }, '조미김': { ing: ['김'] }, '구이김': { ing: ['김'] }, '맛김': { ing: ['김'] }, '구운김': { ing: ['김'] }, '김구이': { ing: ['김'] }, '김부각': { ing: ['김'] },
  ...
  '무생채': { ing: ['무'] }, '오이무침': { ing: ['오이'] }, '깍두기': { ing: ['무'] }, '미니깍두기': { ing: ['무'] }, '석박지': { ing: ['무'] }, '섞박지': { ing: ['무'] }, '무쌈': { ing: ['무'] }, '잘게썬깍두기': { ing: ['무'] }, '코울슬로': { ing: ['양배추'] }, '코울슬로샐러드': { ing: ['양배추'] },
