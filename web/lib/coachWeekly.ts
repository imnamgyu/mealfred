...
JSON만: {"primary_lever":"food"|"environment"|"autonomy"|"texture","mission_target":"콩류","secondary_axis":"식사환경"|null,"expose":2,"push":1,"mission":"이번 주는 ...","impression":"지난주 ... 이번 주는 ..."}`;
...
export function planFromWeekly(p: {
  ...
  if (lever !== 'food' && LEVER_SCENARIO[lever]) {
    ...
    return { scenario: sc(frame), plan, varyOpener: recentPlans[0]?.frame === frame, ledgerPatch: {}, pushApplied: false };
  }
