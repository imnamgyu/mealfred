 ...
 * /privacy — 개인정보처리방침
 *
 * 카카오 간편가입(닉네임) + 자녀의 건강·식이(민감정보) + 식사기록 + 키트 사전예약(배송 정보)을 다룬다.
    ...
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '40px 22px 80px', fontFamily: "'Pretendard',-apple-system,BlinkMacSystemFont,sans-serif", color: '#1a2b4a', lineHeight: 1.75 }}>
      ...
      <Section n="1." t="수집하는 개인정보 항목">
        <ul style={ul}>
          ...
          <li><b>키트 사전예약(신청 시에만)</b>: 수취인 이름, 휴대폰 번호, 배송 주소 — 편식 키트 배송 안내·발송 목적에만 사용합니다.</li>
      ...
      <Section n="3." t="개인정보의 수집·이용 목적">
        <ul style={ul}>
          ...
          <li>식재료 도감 운영</li>
          <li>포인트 적립·사용, 구독·결제, 편식 키트(골고루·집중) 사전예약 접수·주문·배송 안내</li>
      ...
      <Section n="4." t="보유 및 이용 기간">
        <ul style={ul}>
          ...
          <li>키트 사전예약 정보(수취인·연락처·주소)는 배송 완료 또는 신청 취소 후 전자상거래법상 보존 기간이 지나면 파기합니다.</li>
        </ul>
      </Section>
