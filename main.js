...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const quizData = {
    '당근': {
      title: '🥕 당근 5주 코스 (입문)',
      desc: '편식 스코어 62.4. 밀프레드 8개 제품 연계. 주황색 시각 거부 + 아삭 식감. 첫 편식 극복 경험 최적. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '양파': {
      title: '🧅 양파 5주 코스 (입문)',
      desc: '편식 스코어 50.5. 밀프레드 31개 제품 연계. 매운 향+눈물 반응. 볶으면 당도 8→40 Brix. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '두부': {
      title: '🧈 두부 5주 코스 (입문)',
      desc: '편식 스코어 46.6. 물렁 식감 주원인. 바삭 두부스테이크→순두부 순 식감 단계화. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '버섯': {
      title: '🍄 버섯 5주 코스 (도전)',
      desc: '편식 스코어 72.8 (1위). 식감+냄새 이중 거부. 미니 재배키트로 친밀감 형성. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '토마토': {
      title: '🍅 토마토 5주 코스 (도전)',
      desc: '편식 스코어 57.7. 산미+물컹 복합 거부. 소스→건조→생 형태 변환 전략. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '파프리카': {
      title: '🫑 파프리카 5주 코스 (도전)',
      desc: '편식 스코어 49.9. 풋내 주원인. 빨간 파프리카(단맛)부터 시작. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '시금치': {
      title: '🥬 시금치 5주 코스 (고급)',
      desc: '편식 스코어 61.6. 쓴맛+풀냄새+물컹 삼중 거부. 파우더→건조→신선 순. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '브로콜리': {
      title: '🥦 브로콜리 5주 코스 (고급)',
      desc: '편식 스코어 57.5. 전 세계 편식 연구 최다 거부 채소 1위. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    },
    '가지': {
      title: '🍆 가지 5주 코스 (고급)',
      desc: '편식 스코어 60.9. 보라색 시각 거부+물렁 식감. 바삭 가지칩→구이→볶음. 5주(감각놀이 15회+요리 6회)=21회, 연구 권장 범위 초과 달성. 199,000원 · 회당 9,476원'
    }
  };
